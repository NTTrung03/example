    ...
    <section class="bg-team ">
        <div class="container">
            ...
            <div class="text-center text-muted">
                <p class="teammember-sup">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Neque, culpa asperiores.
                    Minima debitis
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-bg-6 col-sm-12 team_img">
                <div class="team_img ">
                    ...
                    <p class="text-center">
                        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Perferendis quia ducimus nam accusantium
                        consectetur earum fugit sed voluptate nemo vel? Est ullam quam modi provident pariatur repudiandae
                        assumenda dicta deserunt.
                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Doloribus quis maiores tempore labore!
                        Quidem, nulla odio. Doloremque cupiditate eligendi quae incidunt. Alias sequi odio suscipit odit
                        quae possimus quis blanditiis.
                    </p>
                </div>
            </div>
        </div>
                    ...
                    @for ($i = 0; $i < 7; $i++)
                        <div class="swiper-slide bg-light rounded-3">
                            <div class="blog-card position-relative overflow-hidden">
                                ...
                                <div class="p-3">
                                    <h4 class="">Test {{ $i }}</h4>
                                    <p class=" text-center dec_team px-1">Lorem ipsum dolor, sit amet consectetur sit amet
                                        consectetur v </p>
                                </div>
