    ...
    <section class="bg-team ">
        <div class="container">
            ...
            <div class="text-center text-muted">
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Neque, culpa asperiores. Minima debitis
            ...
            <div class="col-md-6 col-lg-6 col-sm-2 about_team">
                ...
                <div>
                    <h2 class="fw-bold">Passionate & Dedicated
                        Team Member <br> to delivering
                        exceptional results</h2>
                </div>
            </div>
            ...
            <div class="swiper mySwiper">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="blog-card position-relative overflow-hidden">
                            <img src="img/100.png" alt="" class="w-100">
                            <h4 class="px-1">Test </h4>
                            <p class=" text-center">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Reiciendis</p>
                            <div class="row position-absolute hover-icon">
                                <div class="col-12">
                                    <a href="#" class="text-white">
                                        <i class="bi bi-phone fs-2"></i>
