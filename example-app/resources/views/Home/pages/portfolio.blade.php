@extends('home.index')
@section('body')
    <section class="page_title container d-md-flex align-items-center justify-content-between pb-3 pt-5">
        ...
        <div class="row pb-lg-3">
            <div class="col-md-5 mb-2">
                <div class= "card card-portfolio">
                    ...
                    <div class="my-2 title-portfolio">
                        <h2 class="h4">
            ...
            <div class="col-md-5  mb-2">
                <div class= "card card-portfolio">
                    <div class="card-img">
                        <img src="/img/10.png" alt="" class="rounded-3 object-fit-cover" style="width: 100%">
                    </div>
                    <div class="my-2 title-portfolio">
                        <h2 class="h4">
                            <a href="" class="stretched-link">Astronaut & Flashing Neon Lights</a>
