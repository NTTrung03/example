        ...
        <div class="col-lg-5 col-md-5 col-md-12">
            <div class="row g-2">
                <div class="col-lg-6 col-md-6 col-sm-12 px-1">
                    <img src="/img/Piacquadio.png" alt=""
                        class="w-100 h-50 object-fit-cover py-1 rounded-3">
                    <img src="/img/Petrovic.png" alt=""
                        class="w-100 h-50 object-fit-cover py-1 rounded-3">
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 p-1" style="">
                    <img src="/img/Nilov.png" alt="" class="w-100 h-100 object-fit-cover rounded-3">
                </div>
            </div>
        </div>
