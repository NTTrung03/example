...
<body>
    ...
    <section class=" container ">
        <div class="text-center ">
            ...
            <p class="contact-sup">Have a project in mind? To request a quote contact us directly or fill out <br> the form and let us know
                how we can help.</p>
        </div>
        <div class="">
        ...
        <div class="row">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class=" text-center mt-2">
                            <p class="h4 text-muted mail-sup">Please feel free to drop us a line. <br> We will respond as soon as  possible.</p>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="text-center mt-2 ">
            ...
            <div class="col-md-6 col-lg-6 col-sm-12 mt-4 contact-mail2">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class=" text-center mt-2">
                            <p class="h4 text-muted mail-sup">If you need immediate assistance<br> feel free to call us any time.</p>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="text-center mt-2 ">
